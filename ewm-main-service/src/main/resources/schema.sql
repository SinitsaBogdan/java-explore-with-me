...
CREATE TABLE IF NOT EXISTS participation_requests (
    ...
    CONSTRAINT fk_participation_request_requester FOREIGN KEY (participation_request_user_id) REFERENCES users (id),
    CONSTRAINT fk_participation_request_event FOREIGN KEY (participation_request_event_id) REFERENCES events (id),
